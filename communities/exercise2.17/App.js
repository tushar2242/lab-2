...
const App = () => {
  ...
  return (
   ...
   <h2 style={{display:message}} className='success'>{tempText} has been added </h2> 
     <h2 style={{display:errMessage}} className='error'>Information on {tempText} has been already removed</h2> 
      <Filter
